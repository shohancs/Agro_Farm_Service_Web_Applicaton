				...
				<?php  
					...
					if ( $do == "Manage" ) { ?>
						...
						<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
							<div class="breadcrumb-title pe-3">Manage Post Management</div>
							<div class="ps-3">
													...
													while ( $row = mysqli_fetch_assoc($readPost_query) ) {
															...
															<tr>
															  ...
															  <td>
																<?php 
																	if (!empty($image)) {
																		echo '<img src="assets/images/posts/' . $image . '" style="width: 60px;">';
																	}
																	else {
																		echo '<img src="assets/images/posts/default.png" style="width: 60px; ">';
																	}
																?>
															  </td>
														      ...
														      <td>
														      	<?php  
														      		$userSql = "SELECT * FROM users WHERE status=1 AND user_id='$author_id'";
										...
										<div class="col-lg-4">
											...
											<div class="mb-3">
												...
												<select class="form-select" name="cate_id">
												  ...
												  <?php  
												  	$sql = "SELECT * FROM category WHERE is_parent=1 AND status=1";
					...
					<?php }
						...
						if (isset($_GET['u_id'])) {
							...
							while ($row = mysqli_fetch_assoc($up_idQuery)) {
								...
								<!-- Top Icon -->
						<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
							<div class="breadcrumb-title pe-3">Edit Post Management</div>
							<div class="ps-3">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 p-0">
										<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
						...
						<h6 class="mb-3 text-uppercase">Edit Post Management</h6><hr>
						...
						<!-- Top Icon -->
						<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
							<div class="breadcrumb-title pe-3">Trash Post Manage</div>
							<div class="ps-3">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 p-0">
										<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
										</li>
										<li class="breadcrumb-item active" aria-current="page">Trash Post Manage</li>
									</ol>
								</nav>
							</div>					
						</div>
						...
						<h6 class="mb-3 text-uppercase">Trash Post Manage</h6><hr>
